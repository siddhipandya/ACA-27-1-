...
function setup() {
  ...
  obs1= createSprite(200,200,60,20);
 obs1.velocityX=5;
  obs2= createSprite(20,250,60,20);
  obs2.velocityX=5;
  obs3= createSprite(300,300,60,20);
  obs3.velocityX=5;
  obs4= createSprite(30,350,60,20);
  obs4.velocityX=5;
  obs5= createSprite(400,400,60,20);
  obs5.velocityX=5;
  obs6= createSprite(40,450,60,20);
  obs6.velocityX=5;
  obs7= createSprite(500,500,60,20);
  obs7.velocityX=5;
  obs8= createSprite(50,350,60,20);
  obs8.velocityX=5;
